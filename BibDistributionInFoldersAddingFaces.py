...
def parse_opt():
    ...
    parser.add_argument('--th_faces', type=float, default = 0.15, help='maximum distance between faces')
...
def GenerateFolders(csv1,path_crops,input_path,output_path,th_faces,thres = 0.8,write_text = False):
    ...
    utils.DistributePhotos(input_path, df, output_path, thres, write_text=write_text)
